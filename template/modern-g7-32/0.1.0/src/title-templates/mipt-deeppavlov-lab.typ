...
#let template(
    ...
    if manager.name != none {
        sign-field(manager.at("name"), [Руководитель НИР,\ #manager.at("position")], details: "подпись")
    }

    if performer != none {
        sign-field(performer.at("name", default: none), [Исполнитель НИР,\ #performer.at("position", default: none)], part: performer.at("part", default: none), details: "подпись")
    }
